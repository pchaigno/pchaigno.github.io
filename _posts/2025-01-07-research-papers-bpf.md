...
last_modified_at: 2026-03-10 12:31:00 +0200
categories: bpf
...
So I opted to follow the selection from CSRankings: I will only list papers from [conference listed by CSRankings by default](https://csrankings.org/).
